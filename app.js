...
var addButton=document.querySelector(".new-task__button-add");//add button
...
var createNewTaskElement=function(taskString){
    ...
    checkBox.classList.add("task__completion");
    //label
    ...
    editInput.type="text";
    editInput.className="task__input-text task__input-edit";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="button task__button-edit";

    deleteButton.className="button task__button-delete";
    deleteButtonImg.src='./remove.svg';
    deleteButtonImg.alt = "Delete item";
    deleteButtonImg.classList = "task__button-delete__img";
